	...
	<div class="container p-3">
		<div class="row">
			<div class="col-md-6 p-5">
				<img alt="doctor image" src="image/doc2.jpg">
			</div>
				...
				<div class="card paint-card">
					<div class="card-body">
						...
						<form class="row g-3" action="appAppointment" method="post">
							...
							<div class="col-md-6">
								<label for="inputEmail4" class="form-label">Full Name <span
							...
							<div class="col-md-6">
								<label for="inputEmail4" class="form-label">Age <span
									class="text-danger">*</span>
										</label> <input
							...
							<div class="col-md-6">
								<label for="inputEmail4" class="form-label">Phone No <span
									class="text-danger">*</span>
										</label> <input
							...
							<div class="col-md-6">
								<label for="inputEmail4" class="form-label">Diseases <span
									class="text-danger">*</span>
										</label> <input
							...
							<div class="col-md-6">
								<label for="inputPassword4" class="form-label">Doctor <span
									class="text-danger">*</span>
										</label> <select
